...
export default function Show({ product, relatedProducts }: Props) {
    ...
    const frequentlyBoughtTogether = [
        {
            ...
            price: 1200,
            originalPrice: null,
            description: 'Soft, creamy, and melt-in-your-mouth goodness our signature Malai Chamcham'
        },
        {
            id: '2',
        ...
        },
        {
            ...
            price: 1600,
            originalPrice: 1400,
            description: 'Enjoy receiving three useful products packaged together in one simple bundle.'
        }
    ];
    ...
    const customerRatings = {
        ...
        breakdown: [
            ...
            { stars: 2, percentage: 30, count: Math.floor(5 * 0.30) },
    ...
    const productDescription = {
        ...
        addOns: [
            "Coleslaw, Jalapeños, Onion rings, Bacon strips"
        ],
        variations: [
                                ...
                                <select className="w-full max-w-xs border border-neutral-300 rounded px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary">
                                    {product.available_sizes.map((size) => (
                                        <option key={`${size.kg}-${size.price}`} value={size.kg}>
                                            {size.kg}kg - KES {Number(size.price).toLocaleString()}
                                        </option>
                                    ))}
                                </select>
                            </div>
                                    ...
                                    <ol className="list-decimal list-inside space-y-2 ">
                                        <li>
                                            ...
                                            <ul className="ml-6 mt-2 space-y-1 list-disc list-inside">
                                                {productDescription.ingredients.map((ingredient, idx) => (
                                        ...
                                        <li>
                                            ...
                                            <ul className="ml-6 mt-2 space-y-1 list-disc list-inside">
                                                {productDescription.addOns.map((addon, idx) => (
                                                    <li key={idx}>{addon}</li>
                                                ))}
                                            </ul>
                                        </li>
                                        <li>
                                            <span className="font-semibold">Popular Variations</span>
                                            <ul className="ml-6 mt-2 space-y-1 list-disc list-inside">
                                                {productDescription.variations.map((variation, idx) => (
                                    ...
                                    <div className="flex">
                                        {[1, 2, 3, 4, 5].map((star) => (
                                            <Star
                                                ...
                                                size={24}
                                                className={
                                                    star <= Math.floor(customerRatings.averageRating)
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="flex gap-1 mb-2">
                                        <button className="text-sm px-3 py-1 border border-neutral-300 rounded hover:bg-neutral-100">
                                            {customerRatings.averageRating.toFixed(1)} out of 5 ▼
                                        </button>
                                    </div>
                                </div>
